...
3. **가치투자 (Value Stocks):** 반면, 닷컴 버블 상승장 당시 "미래 성장도 못 하는 낡은 주식만 산다"며 워런 버핏마저 공룡 취급하며 조롱했던 가치투자자들은 어땠을까요? 버블이 붕괴될 때, 실체가 없는 IT 주식에서 도망친 거대한 자금이 튼튼한 이익과 현금흐름을 가진 '가치주'로 몰려들면서 오히려 **플러스 수익률(+)**을 내거나 하락을 완벽히 방어해 내는 기적을 보여주었습니다. (데이터 참조: *Russell 1000 Value Index, 2000.03~2002.10*)
