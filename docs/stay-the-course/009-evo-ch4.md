...
* 앞선 3장에서 보았듯, 대중은 위기 때 파산이 두려워 '작은 주식'부터 가장 먼저 헐값에 내던집니다. 파마는 바로 이 극단적인 공포와 '망할 위험(Risk)'을 짊어진 투자자에게 보상(프리미엄)으로 더 높은 수익이 주어진다는 사실을 수학적으로 증명했습니다. **이 작고도 무거운 발견은, 훗날 제가 거대한 베이스캠프(시장 지수)나 묵직한 방패(SCHD)만으로는 모두 채울 수 없는 투자의 갈증을 '작고 유망한 개별 주식(Satellite)'이라는 조각배에 실어 띄우게 만든 중요한 영감이 됩니다.**
