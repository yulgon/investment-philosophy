...
SPMO's investment philosophy is the exact opposite of value investing (SCHD); it is extremely violent and intuitive.
...
### The Ruthless Logic of Blind Boarding
SPMO analyzes the 12-month returns of S&P 500 companies (excluding the most recent 1 month as short-term noise) and intensively invests in the 100 companies with the highest momentum scores.

Thanks to this ruthless algorithm, in an explosive massive bull market created by human sticky greed (FOMO) and the AI frenzy, SPMO heavily incorporated Big Tech stocks and sucked in enormous profits like a black hole. When value investors gritted their teeth saying, "That's a bubble over there!", SPMO instead used the trend of that bubble (the law of inertia) as rocket fuel to vertically hoist my account's return rate, becoming the perfect **Spear of Attack**.
