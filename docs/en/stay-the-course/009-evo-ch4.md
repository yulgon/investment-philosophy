...
Through history, I gained two truths:
The 'Market (Beta)' to defend against my ignorance, and the 'Value Alpha' to exploit the public's fear.
...
A **'financial superhighway'** was desperately needed to allow individuals to easily buy and sell these complex factor weapons in real-time, just like individual stocks, with the push of a button.
And in 1993, a revolutionary system was born that solved all these distribution problems at once and engraved an indelible barcode in investment history. The story of building that infrastructure continues in **Chapter 5. The Barcode of Innovation: The Birth of ETFs**.
