        ...
        <div class="card fg-card premium-card">
          ...
          <div class="premium-gauge-container">
            <svg viewBox="0 0 200 110" class="premium-gauge-svg">
              ...
              <!-- 5 Gauge Segments -->
              <circle cx="100" cy="100" r="80" fill="none" :stroke="activeIndex === 0 ? '#db2828' : 'rgba(128,128,128,0.2)'" :stroke-width="activeIndex === 0 ? 14 : 8" stroke-dasharray="46 500" stroke-linecap="round" :filter="activeIndex === 0 ? 'url(#glow-active)' : ''" class="gauge-arc" transform="rotate(180 100 100)" />
              <circle cx="100" cy="100" r="80" fill="none" :stroke="activeIndex === 1 ? '#f2711c' : 'rgba(128,128,128,0.2)'" :stroke-width="activeIndex === 1 ? 14 : 8" stroke-dasharray="46 500" stroke-linecap="round" :filter="activeIndex === 1 ? 'url(#glow-active)' : ''" class="gauge-arc" transform="rotate(216 100 100)" />
              <circle cx="100" cy="100" r="80" fill="none" :stroke="activeIndex === 2 ? '#fbbd08' : 'rgba(128,128,128,0.2)'" :stroke-width="activeIndex === 2 ? 14 : 8" stroke-dasharray="46 500" stroke-linecap="round" :filter="activeIndex === 2 ? 'url(#glow-active)' : ''" class="gauge-arc" transform="rotate(252 100 100)" />
              <circle cx="100" cy="100" r="80" fill="none" :stroke="activeIndex === 3 ? '#b5cc18' : 'rgba(128,128,128,0.2)'" :stroke-width="activeIndex === 3 ? 14 : 8" stroke-dasharray="46 500" stroke-linecap="round" :filter="activeIndex === 3 ? 'url(#glow-active)' : ''" class="gauge-arc" transform="rotate(288 100 100)" />
              <circle cx="100" cy="100" r="80" fill="none" :stroke="activeIndex === 4 ? '#21ba45' : 'rgba(128,128,128,0.2)'" :stroke-width="activeIndex === 4 ? 14 : 8" stroke-dasharray="46 500" stroke-linecap="round" :filter="activeIndex === 4 ? 'url(#glow-active)' : ''" class="gauge-arc" transform="rotate(324 100 100)" />

              <!-- Tick marks and text placed perfectly inside the arc -->
              <text x="25" y="103" class="gauge-tick" text-anchor="middle">0</text>
              <text x="45" y="52" class="gauge-tick" text-anchor="middle">25</text>
              <text x="100" y="32" class="gauge-tick" text-anchor="middle">50</text>
              <text x="155" y="52" class="gauge-tick" text-anchor="middle">75</text>
